...
class Color:
    ...
    """
    def __init__(self, hex_str=None, r=None, g=None, b=None, a=1.0,
                 linear_r=None, linear_g=None, linear_b=None, linear_a=1.0):
    ...
    def to_linear(self):
        ...
        if self._linear:
            return Color(linear_r=self._r, linear_g=self._g, 
                        linear_b=self._b, linear_a=self._a)
    ...
    def to_srgb(self):
        ...
        return Color(
            r=inverse_gamma(self._r),
            g=inverse_gamma(self._g),
            b=inverse_gamma(self._b),
            a=self._a
        )
